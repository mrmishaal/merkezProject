...
function TelegramFloatButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[60] hidden items-center gap-2 rounded-full bg-[#229ED9] px-4 py-3 text-sm font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-[#1c8abd] md:inline-flex"
